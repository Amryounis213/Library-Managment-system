...
class FatherRelationsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function (FatherRelation $model) {
                return view('pages.SystemConstants.FatherRelations.parts._action-menu', compact('model'));
            });
     ...
     *
     * @param FatherRelation $model
     *
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FatherRelation $model)
    {
