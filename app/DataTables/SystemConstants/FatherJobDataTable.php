...
class FatherJobDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function (FatherJobs $model) {
                return view('pages.SystemConstants.FatherJobs.parts._action-menu', compact('model'));
            });           
    }
     ...
     */
    public function query(FatherJobs $model)
    {
