...
class EducationalLevelDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function (EducationalLevels $model) {
                return view('pages.SystemConstants.EducationalLevel.parts._action-menu', compact('model'));
            });           
    }
     ...
     *
     * @param EducationalLevels $model
     *
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(EducationalLevels $model)
    {
