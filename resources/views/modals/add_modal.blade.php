                        ...
                        <div id="kt_modal_add_customer_billing_info" class="collapse show">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                ...
                                <select name="country" aria-label="Select a Country" data-control="select2"
                                        ...
                                        data-select2-id="select2-data-13-ppfm" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option value="US" selected="selected" data-select2-id="select2-data-15-wy3m">
                                        United States
                                    </option>
                                    ...
                                    <option value="ZW">Zimbabwe</option>
                                               ...
                                               dir="ltr" data-select2-id="select2-data-14-lotf"
                                               style="width: 100%;"><span class="selection"><span
                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                            role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-disabled="false" aria-labelledby="select2-country-hn-container"
                                            aria-controls="select2-country-hn-container"><span
                                                class="select2-selection__rendered"
                                                id="select2-country-hn-container" role="textbox"
                                                aria-readonly="true" title="United States">United States</span><span
