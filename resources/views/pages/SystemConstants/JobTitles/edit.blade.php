        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h6 class="fw-bolder m-0">تعديل المسمى الوظيفي</h6>
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form" method="POST" action="{{ route('job-titles.update' , $educational->id) }}"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="name"
                                       ...
                                       placeholder="المسمى الوظيفي" value="{{$educational->name}}"/>
                            </div>
                        </div>
