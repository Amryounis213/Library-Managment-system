        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h6 class="fw-bolder m-0">تعديل المهنة </h6>
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="details_form" class="form" method="POST" action="{{ route('father-jobs.update' , $educational->id) }}"
                ...
                <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                        ...
                        <!--begin::Input group-->
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">اسم المهنة</label>
                            <div class="col-lg-8">
                                <input type="text" name="name"
                                       class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 name"
                                       placeholder="اسم المهنة" value="{{$educational->name}}"/>
                            </div>
                        </div>
