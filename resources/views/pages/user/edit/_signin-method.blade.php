...
<div class="card {{ $class ?? '' }}" {{ util()->putHtmlAttributes(array('id' => $id ?? '')) }}>
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{ __('Change Password') }}</h3>
        </div>
    </div>
    <!--end::Card header-->
            ...
            <div class="d-flex flex-wrap align-items-center mb-10">
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    ...
                    <form id="kt_signin_change_password" class="form" novalidate="novalidate" method="POST"
                          action="{{ route('user.changePassword', $user->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-1">
                            <div class="col-lg-4">
                        ...
                        <div
                            class="form-text mb-5">{{ __('Password must be at least 8 character and contain symbols') }}</div>
