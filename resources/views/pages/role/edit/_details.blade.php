...
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h6 class="fw-bolder m-0">{{ __('Edit group') }}</h6>
    ...
    <div id="kt_account_profile_details" class="collapse show">
        <!--begin::Form-->
        <form id="details_form" class="form" method="POST" action="{{ route('role.update', $role) }}"
        ...
        <!--begin::Card body-->
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="{{ __('Full Name') }}" value="{{ old('website', $role->name ?? '') }}"/>
                    </div>
                </div>
                <!--end::Input group-->
            </div>
