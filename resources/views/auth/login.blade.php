...
{{--        <div class="mb-10 bg-light-info p-8 rounded"><div class="text-info"> Use account <strong>admin@demo.com</strong> and password <strong>demo</strong> to continue. </div></div>--}}
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="email" name="email" autocomplete="off" value="{{ old('email') }}" placeholder="demo@demo.com" required autofocus/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
