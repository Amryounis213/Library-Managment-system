...
<div
    ...
    data-kt-menu="true">
    <input id="auth-user-id" value="{{ Auth::user() != null ? Auth::user()->id : '0' }}" type="hidden">
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="d-flex flex-column">
                <div class="fw-bolder d-flex align-items-center fs-5  ms-1">
                    {{ auth()->user()->name }}
                </div>
                <span
                    class="badge badge-light-success fw-bolder fs-8 px-2 py-1">{{ __(auth()->user()->role->name) }}</span>
                <a href="#" class="fw-bold text-muted text-hover-primary fs-7 mt-1 ms-2">{{ auth()->user()->email }}</a>
            </div>
            <!--end::Username-->
        </div>
    </div>
    ...
    <!--begin::Menu item-->
        <div class="menu-item px-5">
            <a href="{{ theme()->getPageUrl('overview.overview') }}" class="menu-link px-5">
                {{ __('My Profile') }}
            </a>
        </div>
        <!--end::Menu item-->
...
{{--                    {{ __('Arabic') }} <img class="w-15px h-15px rounded-1 ms-2"--}}
{{--                                            src="{{ asset(theme()->getMediaUrlPath() . 'flags/palestine.svg') }}"--}}
{{--                                            alt="metronic"/>--}}
{{--                </span>--}}
{{--            </span>--}}
{{--        </a>--}}
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset(theme()->getMediaUrlPath() . 'flags/united-states.svg') }}"
                             alt="metronic"/>
                    </span>
                    {{ __('English') }}
                </a>
            ...
            <div class="menu-content px-5">
                <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success"
                    ...
                    <input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="skin"
                           ...
                           {{ theme()->isDarkMode() ? 'checked' : '' }} data-kt-url="{{ theme()->getPageUrl('index', '', theme()->isDarkMode() ? '' : 'dark') }}"/>
